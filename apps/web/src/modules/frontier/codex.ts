...
export const FRONTIER_CODEX: readonly FrontierCodexEntry[] = [
  ...
  { id:'biome-luminous-grove',category:'biome',title:'Luminous Forest',requiredStage:1,summary:'Biofiber-rich forest illuminated by symbiotic organisms.',detail:'The Luminous Forest teaches renewable material harvesting, living-plot cultivation and ecological recovery without exhausting the biome.' },
  { id:'biome-aether-fields',category:'biome',title:'Crystalline Desert',requiredStage:3,summary:'Mineral desert crossed by exposed Aetherium crystal fields.',detail:'The Crystalline Desert combines scarce shelter, long sightlines and rich Aetherium seams that become dangerous conductors during ion activity.' },
  { id:'biome-tidal-reefs',category:'biome',title:'Biofiber Ocean',requiredStage:5,summary:'Living ocean shaped by floating biofiber reefs and migratory ecosystems.',detail:'Restoration depends on clean energy, seed-stock recovery, water-compatible infrastructure and preserving living substrates.' },
  { id:'biome-thermal-rifts',category:'biome',title:'Ionic Tundra',requiredStage:6,summary:'Frozen terrain swept by electromagnetic fronts and unstable thermal gradients.',detail:'Suit energy, shielding and thermal stabilization are essential while storms alter traversal and expose transient resources.' },
  { id:'biome-cloud-steppe',category:'biome',title:'Floating Mountains',requiredStage:8,summary:'Suspended mountain systems above permanent cloud layers.',detail:'Vertical traversal, atmospheric craft and orbital launch corridors define this high-altitude biome.' },
  { id:'biome-abandoned-city',category:'biome',title:'Abandoned Technological City',requiredStage:9,summary:'A dormant megacity whose infrastructure failed during the Fracture.',detail:'Recovered civic systems, Grid Wardens and sealed transit layers reveal how civilization depended on the Sky Grid and what restoration may reactivate.' },
