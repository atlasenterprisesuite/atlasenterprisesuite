...
export const ATLAS_MODULE_CATALOG: readonly AtlasModuleDefinition[] = Object.freeze([
  ...
  defineModule({
    ...
    moduleCodes: ['accounting', 'finance.accounting'],
  ...
  defineModule({
    ...
    moduleCodes: ['revenue.crm', 'revenue.sales', 'revenue.inventory', 'revenue.pos', 'revenue.projects'],
  ...
  defineModule({
    ...
    moduleCodes: ['platform.automations', 'platform.site_review'],
