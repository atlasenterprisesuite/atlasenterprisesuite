  ...
  return (
    <section className="spatial-entry" aria-labelledby="spatial-title">
      ...
      <div className="spatial-content">
        <p className="eyebrow">One governed ecosystem</p>
        ...
        <div className="spatial-actions">
          <Link className="primary-action" to="/health">Enter ATLAS Health</Link>
          <span className="environment-chip">Development foundation</span>
        </div>
