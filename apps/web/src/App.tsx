  ...
  return (
    <section className="page-stack">
      ...
      <div className="module-grid">
        <Link className="module-card enabled" to="/finance"><span>Business</span><strong>Finance</strong><p>Accounting and financial operations, including payables and automotive sales reporting.</p></Link>
