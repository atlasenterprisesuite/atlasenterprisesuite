...
function runtime(){
  ...
  return {serviceRoleKey,storageConfigured:Boolean(serviceRoleKey),openaiKey,bedrockKey,geminiKey,openaiModels,bedrockModels,bedrockEndpoint,bedrockRegion,bedrockBaseUrl,bedrockRuntimeVerified,geminiModels,codexEndpoint,codexToken,codexModel,realtimeModel,realtimeEnabled,realtimeAllowPaid,realtimeTranscriptionModel,costPolicy};
}
