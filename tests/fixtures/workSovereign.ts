export const workWorkflowFixtures = [
  {
    id: 'wf-now', ownerModule: 'manager', status: 'now', currentTaskId: 'task-now', currentModule: 'manager',
  ...
  {
    id: 'wf-approval', ownerModule: 'manager', status: 'awaiting_approval', currentTaskId: 'task-approval', currentModule: 'manager',
  ...
  {
    id: 'wf-completed', ownerModule: 'finance', status: 'completed', currentTaskId: 'task-completed', currentModule: 'finance',
  ...
  {
    id: 'wf-blocked', ownerModule: 'studio', status: 'blocked', currentTaskId: 'task-blocked', currentModule: 'studio',
  ...
  {
    id: 'wf-failed', ownerModule: 'ride', status: 'failed', currentTaskId: 'task-failed', currentModule: 'ride',
    createdAt: '2026-09-10T12:00:00Z', updatedAt: '2026-09-10T12:05:00Z', completedAt: null,
    work: { executionMode: 'hybrid', autonomyLevel: 'guided', runtimePreference: 'auto', budgetLimit: 0, connectionRefs: [] }
  },
  {
    id: 'wf-cancelled', ownerModule: 'payroll', status: 'cancelled', currentTaskId: 'task-cancelled', currentModule: 'payroll',
