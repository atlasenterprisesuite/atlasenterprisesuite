...
describe('ATLAS FRONTIER route contract', () => {
  ...
  it('loads durable campaign, ecology, expansion, survival and spatial world state', () => {
  ...
  it('surfaces survival state and dynamic hazard evidence in the player UI', () => {
    expect(routes).toContain('SURVIVAL SYSTEMS');
