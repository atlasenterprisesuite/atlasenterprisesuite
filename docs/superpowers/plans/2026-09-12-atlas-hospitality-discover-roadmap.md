...
2. `2026-09-12-atlas-hospitality-map-concierge.md`
...
3. `2026-09-12-atlas-hospitality-local-commerce.md`
   - offers;
   - inventory/eligibility;
   - redemption transaction;
   - visitor Deals UI.

4. `2026-09-12-atlas-hospitality-partners-campaigns-analytics.md`
   - partner management;
   - verification/review;
...
5. `2026-09-12-atlas-hospitality-assistant-integrations.md`
   - itinerary engine;
   - saved itineraries;
...
- Plans 2–5 depend on Plan 1.
- Plan 3 does not require a map provider to function.
- Plan 4 can begin after Plan 1; campaign-to-offer references are enabled only after Plan 3 contracts exist.
- Plan 5 can begin itinerary/Assistant read-only work after Plan 1; offer, campaign, Ride, Pay, CRM, Creator, and Accounting capabilities remain fail-closed until their corresponding contracts are present and verified.
