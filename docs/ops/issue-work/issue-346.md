...
- Source: https://github.com/atlasenterprisesuite/atlasenterprisesuite/issues/346
- Branch: atlas/issue-346-atlas-auto-workspace-end-to-end-verification
- Base: main
