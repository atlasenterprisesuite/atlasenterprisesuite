...
Code, validation, deployment, runtime, and public-edge verification are tracked separately. Provider-dependent capabilities never claim `live`, `online`, `connected`, or `verified` status without evidence.
